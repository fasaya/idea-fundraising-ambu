        ...
        <div class="col">
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="" action="<?= base_url() ?>adminpanel/editblog/<?= $blog['id_blog']; ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <a href="<?= base_url() ?>adminpanel/hapusblog/<?= $blog['id_blog']; ?>" class="mb-1 mt-1 mr-1 btn btn-danger">Delete</a>
