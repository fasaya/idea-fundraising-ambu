        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <p class="mb-0">Ukuran gambar yang disarankan 1920x725px. Gambar Header tampil pada halaman Tentang, Visi dan Misi, AD/RT, Blog/Kegiatan, dan Struktur Organisasi</p>
                </header>
                <div class="card-body">
