	...
	<div class="slider-container rev_slider_wrapper" style="height: 750px;">
		<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1110, 'gridheight': [750,750,750,1250], 'responsiveLevels': [4096,1200,992,500]}">
			<ul>
				...
				<li class="slide-overlay slide-overlay-level-7" data-transition="fade">
					<img src="<?= base_url() ?>template/img/demos/digital-agency/slides/slide-digital-agency-3.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="on" data-duration="9000" data-ease="Linear.easeNone" data-scalestart="115" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 400px" data-offsetend="0 -400px" data-bgparallax="0" class="rev-slidebg">

					<div class="tp-caption tp-caption-overlay-opacity top-label font-weight-semibold" data-frames='[{"delay":1000,"speed":1000,"sfxcolor":"#212529","sfx_effect":"blockfromleft","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#212529","sfx_effect":"blocktoleft","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]' data-x="left" data-hoffset="['550','550','550','450']" data-y="center" data-voffset="['-65','-65','-69','-73']" data-fontsize="['18','18','18','30']" data-paddingtop="['10','10','10','12']" data-paddingbottom="['10','10','10','12']" data-paddingleft="['18','18','18','18']" data-paddingright="['18','18','18','18']">HELLO, WE CREATE</div>

					<div class="tp-caption tp-caption-overlay-opacity main-label" data-frames='[{"delay":1300,"speed":1000,"sfxcolor":"#212529","sfx_effect":"blockfromleft","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#212529","sfx_effect":"blocktoleft","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]' data-x="left" data-hoffset="['550','550','550','450']" data-y="center" data-fontsize="['50','50','50','60']" data-paddingtop="['10','10','10','12']" data-paddingbottom="['10','10','10','12']" data-paddingleft="['18','18','18','18']" data-paddingright="['18','18','18','18']">INCREDIBLE DESIGNS</div>

					<div class="tp-caption font-weight-light text-color-light ws-normal" data-frames='[{"from":"opacity:0;","speed":300,"to":"o:1;","delay":2000,"split":"chars","splitdelay":0.05,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]' data-x="left" data-hoffset="['550','550','550','450']" data-y="center" data-voffset="['65','65','65','105']" data-width="['600','600','600','600']" data-fontsize="['18','18','18','30']" data-lineheight="['29','29','29','40']">amazing solutions for our clients, contact us to learn how we can help.</div>

					<a class="tp-caption btn btn-primary font-weight-bold" href="#" data-frames='[{"delay":3000,"speed":2000,"frame":"0","from":"y:50%;opacity:0;","to":"y:0;o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]' data-x="left" data-hoffset="['550','550','550','450']" data-y="center" data-voffset="['140','140','140','235']" data-paddingtop="['16','16','16','31']" data-paddingbottom="['16','16','16','31']" data-paddingleft="['40','40','40','50']" data-paddingright="['40','40','40','50']" data-fontsize="['13','13','13','25']" data-lineheight="['20','20','20','25']">GET STARTED NOW <i class="fas fa-arrow-right ml-1"></i></a>
	...
	<div class="container card-body">
		<div class="row">
			<div class="col-sm-12 col-lg-12 mb-12 mb-lg-12">
				<h3 class="text-center appear-animation" data-appear-animation="fadeInRightShorter">Donatur</h3>
				<table class="table table-responsive-md table-striped mb-0 appear-animation" data-appear-animation="fadeInRightShorter" id="table_fixed">
					<thead>
						<tr>
							<th>Nama</th>
							<th>Provinsi</th>
				...
				<div id="contain" class="appear-animation" data-appear-animation="fadeInRightShorter" style="height: 50%; overflow-y: scroll; ">
					<table class="table table-responsive-md table-striped mb-0" id="table_scroll">
						<tbody>
							<tr>
								<td>Mark</td>
				...
				<div class="carousel-areas mb-0" style="margin-top: -10px;">
					<div class="owl-carousel owl-theme nav-style-1 m-0" data-plugin-options="{'autoHeight': true, 'items': 1, 'margin': 10, 'nav': true, 'dots': false, 'stagePadding': 0}">
						<div>
							...
							<a href="#">
								<img alt="" class="img-fluid rounded-0" src="<?= base_url() ?>template/img/previews/areas/areas-1.png">
							</a>
						</div>
						<div>
							<div class="col px-2 text-2">
							...
							<a href="#">
								<img alt="" class="img-fluid rounded-0" src="<?= base_url() ?>template/img/previews/areas/areas-2.png">
							</a>
						</div>
					</div>
				</div>
		...
		<div class="container my-4">
			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-4 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
					<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-remove-right-quote mb-0">
						<div class="testimonial-author">
							<img src="<?= base_url() ?>template/img/clients/client-1.jpg" class="img-fluid rounded-circle mb-0" alt="">
						</div>
						<blockquote>
				...
				<div class="col-md-8 col-lg-4 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="100">
					<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-remove-right-quote mb-0">
						<div class="testimonial-author">
							<img src="<?= base_url() ?>template/img/clients/client-2.jpg" class="img-fluid rounded-circle mb-0" alt="">
						</div>
						<blockquote>
							<p class="px-xl-2 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas molestie.</p>
						</blockquote>
				...
				<div class="col-md-8 col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
					<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-remove-right-quote mb-0">
						<div class="testimonial-author">
							<img src="<?= base_url() ?>template/img/clients/client-3.jpg" class="img-fluid rounded-circle mb-0" alt="">
						</div>
						<blockquote>
							<p class="px-xl-2 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas molestie.</p>
						</blockquote>
			...
			<div class="row">
				<div class="col">
					<div class="owl-carousel owl-theme mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 7}, '1200': {'items': 7}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-1.png" alt="">
						</div>
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-2.png" alt="">
						</div>
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-3.png" alt="">
						</div>
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-4.png" alt="">
						</div>
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-5.png" alt="">
						</div>
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-6.png" alt="">
						</div>
						<div>
							<img class="img-fluid opacity-2" src="<?= base_url() ?>template/img/logos/logo-4.png" alt="">
						</div>
